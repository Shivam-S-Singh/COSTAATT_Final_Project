...
\title{Harnessing Software Engineering Principles in Network Communication \\
\vspace{0.5cm}
...
The traditional methods of managing the network has led to longer turnaround times with regards to troubleshooting issues, and scalability when making configuration changes to accommodate new devices or applications. Below are the following areas of interest.
